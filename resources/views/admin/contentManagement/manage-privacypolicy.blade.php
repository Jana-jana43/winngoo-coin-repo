                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h3 class="mb-sm-0">Manage Privacy Policy</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form id="privacyForm" method="POST" action="{{ route('admin.save.privacy') }}">
    @csrf

    <div class="card-body">
        <!-- Hidden textarea to store Summernote content -->
...
@push('scripts')
    ...
    // Load DB content
    let content = `{!! old('content', $privacy->content ?? '') !!}`;
