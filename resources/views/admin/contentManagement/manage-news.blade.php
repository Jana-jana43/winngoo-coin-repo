                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h3 class="mb-sm-0">Manage News</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           ...
                           <form id="newsForm" method="POST" action="{{ route('admin.save.news') }}">
    @csrf
...
$(document).ready(function() {
    ...
    let content = `{!! old('content', $news->content ?? '') !!}`;
