function initializeTables() {
    new DataTable("#manageFaq"),new DataTable("#manageRole"),new DataTable("#manage-notification"),new DataTable("#manageFaq"),
        new DataTable("#manageTeam", { fixedHeader: !0 , dom: "Bfrtip", buttons: ["csv", "excel", "print", "pdf"] }),
        ...
        new DataTable("#fixed-header", { fixedHeader: !0 , dom: "Bfrtip", buttons: ["csv", "excel", "print", "pdf"] }),
